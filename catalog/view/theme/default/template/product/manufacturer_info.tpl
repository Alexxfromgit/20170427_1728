...
<!--			</div>
      ...
      <?php } ?>
      <div class="cart">
        <input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>'); yaCounter33380443.reachGoal('addToCart_nk'); return true; ga('send', 'event', 'Knopka', 'Podtverdit')" class="button" />
      </div>
