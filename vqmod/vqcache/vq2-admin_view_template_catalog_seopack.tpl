			...
			<tbody>
              <tr>
                ...
                <td class="right">
					...
					<a onclick="location = 'keywords_generator.php?token=<?php echo $this->session->data['token']; ?>'" class="button">Generate</a>
					<?php } else { ?>
			...
			<tbody>
              <tr>
                ...
                <td class="right">
					...
					<a onclick="location = 'meta_description_generator.php?token=<?php echo $this->session->data['token']; ?>'" class="button">Generate</a>
					<?php } else { ?>
			...
			<tbody>
              <tr>
                ...
                <td class="right">
					...
					<a onclick="location = 'tag_generator.php?token=<?php echo $this->session->data['token']; ?>'" class="button">Generate</a>
					<?php } else { ?>
			...
			<tbody>
              <tr>
                ...
                <td class="right">
					...
					<a onclick="location = 'rp_generator.php?token=<?php echo $this->session->data['token']; ?>'" class="button">Generate</a>
					<?php } else { ?>
...
<p><a onclick="clearseo('Product Custom Alts', '<?php echo $clearalts; ?>');" class="button" style="background:red">Clear Custom Alts</a></p>
<p><a onclick="clearseo('Product Custom H1s', '<?php echo $clearh1s; ?>');" class="button" style="background:red">Clear Custom H1s</a></p>
<p><a onclick="clearseo('Product Custom Titles', '<?php echo $cleartitles; ?>');" class="button" style="background:red">Clear Custom Titles</a></p>
