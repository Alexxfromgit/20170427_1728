...
$this->data['text_makemodel'] = $this->language->get('text_makemodel');
				$this->data['text_ymmexport'] = $this->language->get('text_ymmexport');
...
$this->data['makemodel'] = $this->url->link('catalog/makemodel', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['ymmexport'] = $this->url->link('catalog/ymmexport', 'token=' . $this->session->data['token'], 'SSL');
