...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $custom_alt; ?>" id="image" /></a></div>
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional">
        <?php foreach ($images as $image) { ?>
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="colorbox"><img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $custom_alt; ?>" /></a>
        <?php } ?>
      </div>
      <?php } ?>
    </div>
    ...
    <div class="right">
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
		  ...
		  <span class="detail-buy-btn-container">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<span class="sprite-side btn-link btn-link-green detail-buy-btn-link">
		<input class="btn-link-i" type="submit" onclick="yaCounter33380443.reachGoal('addToCart_nk'); return true; ga('send', 'event', 'Knopka', 'Podtverdit')" value="Купить" id="button-cart"><br><br><br>
        </input>
		</span>
	</span>
 ...
 <span>&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;</span>
        ...
        <?php } ?>
							...
							<div>
								<a style="margin-left:55px; font-size:15px; color:#009FFF;" id="spcallmeback_btn_1" class="spcallmeback_raise_btn" href="#spcallmeback_1">Получить больше информации</a><br>
								<a style="margin-left:55px; font-size:15px; color:#009FFF;" href="dostavka">Доставка по Харькову и регионам</a>
							</div>
    </div>
  </div>
