...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->document->setTitle($product_info['name'].' - купить в Харькове, Днепропетровске, Одессе, Киеве. Доставка по всей Украине | Автозапчасти от Технорайд');
			$this->document->setDescription('Купить '.$product_info['meta_description'].' в Харькове, всегда в наличии. Доставка по всей Украине. Консультация от профессионалов, подробнее...');
