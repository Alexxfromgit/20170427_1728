...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	public function index() {
		...
		$this->redirect($this->url->link('catalog/product_quick', 'token=' . $this->session->data['token'], 'SSL'));
		}
...
$this->data['entry_custom_alt'] = $this->language->get('entry_custom_alt');
$this->data['entry_custom_h1'] = $this->language->get('entry_custom_h1');
...
$this->data['entry_make'] = $this->language->get('entry_make');
		$this->data['entry_model'] = $this->language->get('entry_model');
    	...
    	$this->data['button_add_ymm'] = $this->language->get('button_add_ymm');
...
$this->data['tab_ymm'] = $this->language->get('tab_ymm');
...
$this->data['make_complete_url'] =  $this->url->link('catalog/makemodel/completemake', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['model_complete_url'] =  $this->url->link('catalog/makemodel/completemodel', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['engine_complete_url'] =  $this->url->link('catalog/makemodel/completeengine', 'token=' . $this->session->data['token'], 'SSL');
...
if (isset($this->request->post['product_ymms'])) {
