...
// Entry
$_['entry_custom_alt']            = 'Custom Alt:<br/><span class="help">Leave empty if you want the default image alt to be displayed</span>';
$_['entry_custom_h1']            = 'Custom H1:<br/><span class="help">Leave empty if you want the default header to be displayed</span>';
$_['entry_custom_title']            = 'Custom title:<br/><span class="help">Leave empty if you want the default title to be displayed</span>';
...
$_['entry_upc']              = 'UPC:<br/><span class="help">Universal Product Code, универсальный общепризнанный уникальный код этого товара</span>';
