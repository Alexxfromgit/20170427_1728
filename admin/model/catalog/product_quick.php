...
class ModelCatalogProductQuick extends Model {
	...
	public function changePrice($product_id, $price) {
		if ($this->user->hasPermission('modify', 'catalog/product_quick')) {
			$this->db->query("UPDATE " . DB_PREFIX . "product SET price = '" . (float)$price . "' WHERE product_id = '". $product_id . "'");
		}
	...
	public function changeStatus($product_id, $column_name, $value){
		if ($this->user->hasPermission('modify', 'catalog/product_quick')) {
	...
	public function changeDiscountPrices($product_id, $data){
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_discount WHERE product_id = '" . (int)$product_id . "'");
	...
	public function changeDownloads($product_id, $data){
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_to_download WHERE product_id = '" . (int)$product_id . "'");
	...
	public function changeStores($product_id, $data){
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_to_store WHERE product_id = '" . (int)$product_id . "'");
	...
	public function changeCodes($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeTaxClasses($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET tax_class_id = '" . $this->db->escape($data['tax_class_id']) . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductMinimum($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET minimum = '" . (int)$data['minimum'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductSubtract($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', shipping = '" . (int)$data['shipping'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductDimension($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductWeight($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductDateSort($product_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "product SET date_available = '" . $this->db->escape($data['date_available']) . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW() WHERE product_id = '" . (int)$product_id . "'");
		
		$this->cache->delete('product');
	}
	
	public function changeProductRewardPoints($product_id, $data){
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_reward WHERE product_id = '" . (int)$product_id . "'");
	...
	public function changeProductDesign($product_id, $data){
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_to_layout WHERE product_id = '" . (int)$product_id . "'");
	...
	public function changeProductFilters($product_id, $data) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_filter WHERE product_id = '" . (int)$product_id . "'");
