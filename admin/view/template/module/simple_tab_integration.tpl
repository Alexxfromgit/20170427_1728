      ...
      <table class="form">
        ...
        <tr>
          <td colspan="2">
            ...
            <a class="button" target="_blank" href="<?php echo $header_save_link ?>"><span><?php echo $l->get('button_download') ?></span></a>
          </td>
        </tr>
        <tr>
          <td colspan="2">
            ...
            <a class="button" target="_blank" href="<?php echo $footer_save_link ?>"><span><?php echo $l->get('button_download') ?></span></a>
          </td>
        </tr>
      </table>
    </vtab>
    <vtab title="<?php echo $l->get('tab_javascript', true) ?>" title-lang-id="tab_javascript">
      <table class="form">
        ...
        <tr>
          ...
          <td>
            <textarea rows="10" cols="150" ng-model="settings.javascriptCallback"></textarea>
          </td>
        </tr>
      </table>
    </vtab>
