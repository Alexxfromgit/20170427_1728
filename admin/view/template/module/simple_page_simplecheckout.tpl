        ...
        <htabs>
            <htab title="<?php echo $l->get('tab_simplecheckout_template', true) ?>" title-lang-id="tab_simplecheckout_template">
                <div ng-controller="simpleStepsController" ng-init="checkout.steps = !empty(checkout.steps) ? checkout.steps : [];">
                    ...
                    <a ng-click="addStep()"><h3><?php echo $l->get('text_add_step'); ?></h3></a>
                    <table class="form" ng-repeat="step in checkout.steps">
                        <tr ng-init="step.label = !empty(step.label) ? step.label : {}" ng-show="checkout.steps.length > 1">
                            ...
                            <td>
                                <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="step.label[l.code]"></div>
                                <div style="font-weight:bold;"><a ng-show="$index > 0" ng-click="removeStep(step.id)"><?php echo $l->get('text_remove_step'); ?></a></div>
                            </td>    
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td ng-init="step.template = !empty(step.template) ? step.template : ''">
                                ...
                                <textarea cols="150" rows="1" ng-model="step.template" ng-show="step.manual"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <htab title="<?php echo $l->get('tab_simplecheckout_shipping', true) ?>" title-lang-id="tab_simplecheckout_shipping" ng-init="checkout.shipping = !empty(checkout.shipping) ? checkout.shipping : {}">
                ...
                <div class="warning"><?php echo $empty_shipping_methods; ?></div>
                <?php } ?>
                ...
                <div ng-repeat="method in checkout.shipping.methods" ng-init="checkout.shipping.methods = !empty(checkout.shipping.methods) ? checkout.shipping.methods : {}">
                    ...
                    <table class="form">
                        ...
                        <tr ng-init="method.title = !empty(method.title) ? method.title : {}">
                            ...
                            <td>    
                                <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="method.title[l.code]"></div>
                    ...
                    <div style="padding-left:40px;">
                        <div ng-repeat="submethod in method.methods" style="border-left:1px solid #CCCCCC;padding-left:20px;">
                            ...
                            <table class="form">
                                ...
                                <tr ng-init="submethod.display = !empty(submethod.display) ? submethod.display : method.display">
                                    <td><?php echo $l->get('entry_display_stub') ?></td>
                                    <td>    
                                        <input type="checkbox" ng-model="submethod.display">
                                    </td>
                                </tr>
                                <tr ng-show="submethod.display" ng-init="submethod.title = !empty(submethod.title) ? submethod.title : {}">
                                    <td><?php echo $l->get('entry_method_title') ?></td>
                                    <td>    
                                        <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="submethod.title[l.code]"></div>
                                        <label><input type="checkbox" ng-model="submethod.useTitle"><?php echo $l->get('text_use_this_title_always') ?></label>
                                    </td>
                                </tr>                        
                                <tr ng-show="submethod.display" ng-init="submethod.description = !empty(submethod.description) ? submethod.description : {}">
                                    <td><?php echo $l->get('entry_method_description') ?></td>
                                    <td>    
                                        <div ng-repeat="l in languages"><img style="vertical-align:top;" ng-src="view/image/flags/{{l.image}}" />&nbsp;<textarea  cols="50" ng-model="submethod.description[l.code]"></textarea></div>
            ...
            <htab title="<?php echo $l->get('tab_simplecheckout_payment', true) ?>" title-lang-id="tab_simplecheckout_payment" ng-init="checkout.payment = !empty(checkout.payment) ? checkout.payment : {}">
                ...
                <div ng-repeat="method in checkout.payment.methods" ng-init="checkout.payment.methods = !empty(checkout.payment.methods) ? checkout.payment.methods : {}">
                    ...
                    <table class="form">
                        ...
                        <tr ng-show="method.display" ng-init="method.title = !empty(method.title) ? method.title : {}">
                            <td><?php echo $l->get('entry_method_title') ?></td>
                            <td>    
                                <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="method.title[l.code]"></div>
                                <label><input type="checkbox" ng-model="method.useTitle"><?php echo $l->get('text_use_this_title_always') ?></label>
                        ...
                        <tr ng-show="method.display" ng-init="method.description = !empty(method.description) ? method.description : {}">
                            <td><?php echo $l->get('entry_method_description') ?></td>
                            <td>    
                                <div ng-repeat="l in languages"><img style="vertical-align:top;" ng-src="view/image/flags/{{l.image}}" />&nbsp;<textarea  cols="50" ng-model="method.description[l.code]"></textarea></div>
                ...
                <table class="form" ng-init="checkout.comment = !empty(checkout.comment) ? checkout.comment : {}">
                    <tr>
                        ...
                        <td ng-init="checkout.comment.label = !empty(checkout.comment.label) ? checkout.comment.label : {}">
                            <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" ng-model="checkout.comment.label[l.code]" size="50"></div>
                        </td>    
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td ng-init="checkout.comment.placeholder = !empty(checkout.comment.placeholder) ? checkout.comment.placeholder : {}">
                            <div ng-repeat="l in languages"><img ng-src="view/image/flags/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="checkout.comment.placeholder[l.code]"></div>
                        </td>    
                    </tr>           
                </table>
            </htab>
