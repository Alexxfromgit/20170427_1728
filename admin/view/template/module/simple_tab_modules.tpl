<table id="module" class="list">
  ...
  <tbody ng-init="settings.modules = !empty(settings.modules) ? settings.modules : []">
    <tr ng-repeat="module in settings.modules">
      ...
      <td class="left"><a ng-click="settings.modules.splice($index, 1)" class="button"><?php echo $l->get('button_remove'); ?></a></td>
    </tr>
  </tbody>
  <tfoot>
    <tr>
      <td colspan="5"></td>
      <td class="left"><a ng-click="settings.modules.push({})" class="button"><?php echo $l->get('button_add_module'); ?></a></td>
    </tr>
  </tfoot>
</table>