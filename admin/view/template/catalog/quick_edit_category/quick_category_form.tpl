...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/category.png" alt="" /> <?php echo $heading_title; ?><span class="category_name"></span></h1>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][name]" size="103" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?>" />
...
//--></script> 
<script type="text/javascript"><!--
$category_name = $('input[name="category_description[<?php echo $this->config->get('config_language_id'); ?>][name]"]'); 
$title = $('.category_name');

if ($category_name.val() != '') {
	$title.html(' - ' + $category_name.val()); 
}
