          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" size="103" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                ...
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]"  size="103" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?>" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" size="103" /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              ...
              <td><div class="scrollbox" style="height: 245px;">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($categories as $category) { ?>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-filter" class="scrollbox"  style="height: 245px;">
                  <?php $class = 'odd'; ?>
...
function getProducts() {
	...
	$.ajax({
		url: 'index.php?route=catalog/product_quick/category&token=<?php echo $token; ?>&category_id=' + $('#category').attr('value'),
		dataType: 'json',
...
function getRelated() {
	...
	$.ajax({
		url: 'index.php?route=catalog/product_quick/related&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
...
//--></script>
<script type="text/javascript"><!--
$heading_name = $('input[name="product_description[<?php echo $this->config->get('config_language_id'); ?>][name]"]'); 
$title = $('.heading_name');
if ($heading_name.val() != '') {
